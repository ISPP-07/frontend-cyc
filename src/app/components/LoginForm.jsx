...
function LoginForm({ onToggle }) {
	...
	if (!showEmergency) {
		...
		return (
			<div className='flex flex-col items-center bg-gray-50 rounded-xl p-10 drop-shadow-lg w-[335px] h-[404px]'>
				<h1 className='mb-10 text-center font-poppins text-2xl'>
					<strong>Emergencia</strong>
				</h1>
				<p className='text-center w-48'>
					Si ningún usuario puede iniciar sesión, pulse el botón{' '}
					<span className='text-red-600 font-bold'>
						{'"Necesitamos Ayuda"'}
					</span>
					. Se le notificará a los desarrolladores el problema y se le asistirá
					lo antes posible.
				</p>
				<div className='flex items-center justify-between gap-2 mt-5'>
					<button
						...
						className='bg-red-400 hover:bg-red-500 rounded-md drop-shadow-lg p-1 cursor-pointer text-white'
					>
						Cancelar
					</button>
					...
					<button
						...
						className='bg-red-600 hover:bg-red-700 rounded-md drop-shadow-lg p-1 cursor-pointer text-white'
					>
						Necesitamos ayuda
					</button>
				</div>
