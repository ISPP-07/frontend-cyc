	...
	return (
		<div className='absolute top-10 left-1/4 w-4/6 h-10 flex justify-start items-center'>
			...
			<button className="bg-blue-500 ml-auto mr-6 relative rounded-full font-Varela text-xs w-8 h-8	">
				<Image src="/filter.svg" className='ml-1.5' width={20}height={20}></Image>
			</button>
			<button className="bg-green-700 relative rounded-full font-Varela text-sm w-2/12 h-8 float-right">Añadir elemento</button>
		</div>
	)
}
