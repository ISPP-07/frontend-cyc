	...
	return (
			<div className="absolute h-screen rounded-md border border-solid w-[300px] shadow-xl">
				<div className="absolute h-32 bg-white rounded-none w-[299px] ">
					<Image src="/cyc.png" className="absolute rounded-none top-[21px] left-[27px]" width={100} height={100}></Image>
				...
				<div className="absolute top-[138px] w-[300px] flex flex-col leading-6 opacity-100 gap-[12px]">
					...
					<div className="flex items-center text-gray-900 whitespace-no-wrap text-xl cursor-pointer justify-start w-[299px] sidebar-menu-item">
						...
						<Link href="/link6" className="ml-5 font-Varela text-171a1fcf text-base text3">
							Entregas
						</Link>
					</div>
					<div className="flex items-center text-gray-900 whitespace-no-wrap text-xl cursor-pointer justify-start w-[299px] sidebar-menu-item">
						<Image src="/square-plus.svg" width={18} height={18} className="relative left-[30px]"></Image>
						<Link href="/link7" className="ml-10 font-Varela text-171a1fcf text-base text4">
							Añadir entregas
						</Link>
					</div>
					<div className="flex items-center text-gray-900 whitespace-no-wrap text-xl cursor-pointer justify-start w-[299px] sidebar-menu-item">
						<Image src="/bell.svg" width={18} height={18} className="relative left-[10px]"></Image>
						<Link href="/link8" className="ml-5 font-Varela text-171a1fcf text-base text3">
							Notificaciones
						</Link>
					</div>
					<div className="flex items-center text-gray-900 whitespace-no-wrap text-xl cursor-pointer justify-start w-[299px] sidebar-menu-item">
						<Image src="/face.svg" width={18} height={18} className="relative left-[10px]"></Image>
						<Link href="/link9" className="ml-5 font-Varela text-171a1fcf text-base text3">
							Usuarios
						</Link>
					</div>
					<div className="flex items-center text-gray-900 whitespace-no-wrap text-xl cursor-pointer justify-start w-[299px] sidebar-menu-item">
						<Image src="/face-plus.svg" width={18} height={18} className="relative left-[30px]"></Image>
						<Link href="/link10" className="ml-10 font-Varela text-171a1fcf text-base text4">
