...
export default async function FamiliesIdPage() {    
    ...
    return (
        ...
        <Sidebar/>
        <div className="h-full absolute w-2/6 bg-white-700 z-50 ml-[300px] border border-solid shadow-xl" >
            <div className="h-28 relative flex justify-start">
                ...
                <p className="font-Varela mt-12 ml-4 text-black text-2xl w-32"> {familyFirstInList.name} </p>
                <div className=" h-28 w-32 flex flex-row items-center justify-end">
                <button className=" border border-blue-500  h-8 w-8 rounded-full shaddow-2xl mt-3 mr-4"> 
            ...
            <div className="h-8 relative flex justify-start">
                <button className=" bg-green-700 rounded-3xl w-32 ml-10 shadow-2xl font-Varela text-sm">+  Nuevo reparto</button>
            </div>
            <div className="h-20 relative w-96">
            <hr className='mt-4 w-3/4 mx-auto border-t border-dotted bg-gray-300'></hr>
            ...
            <hr className='mt-3 w-3/4 mx-auto border-t border-dotted bg-gray-300'></hr>
            </div>
